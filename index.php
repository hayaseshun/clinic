...
<main class="main">
  <div class="top">
    <a class="page-top-btn util-btn-hover-2">
      <p>WEB予約<br>はこちら</p>
    </a>
  ...
  <section class="concept">
    <div class="concept-inner">
      <div class="concept-content">
        ...
        <div class="concept-message">健康的で素敵な笑顔あふれる
          街づくりを目指して</div>
    ...
    <div class="announce-bg">
      <div class="section-inner">
        ...
        <div class="announce-items">
          <a href="" class="announce-item">
            <div class="announce-picture1">
